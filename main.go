...
func main() {
	...
	// Users
	router.HandleFunc("/people", e.CORSMiddleware(repository.GetPeople)).Methods("OPTIONS", "GET") // add e.TokenAuthMiddleware
	router.HandleFunc("/people/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(GetPerson))).Methods("OPTIONS", "GET")
	...
	router.HandleFunc("/people/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(DeletePerson))).Methods("OPTIONS", "DELETE")
	router.HandleFunc("/people/reset", e.CORSMiddleware(ResetPassword)).Methods("OPTIONS", "POST")

	// Favorite
	router.HandleFunc("/favorite", e.CORSMiddleware(e.TokenAuthMiddleware(AddFavorite))).Methods("OPTIONS", "POST")
	router.HandleFunc("/favorite", e.CORSMiddleware(e.TokenAuthMiddleware(GetFavorites))).Methods("OPTIONS", "GET")
	router.HandleFunc("/favorite/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(DeleteFavorite))).Methods("OPTIONS", "DELETE")

	// Courses
	router.HandleFunc("/courses", e.CORSMiddleware(e.TokenAuthMiddleware(GetCourses))).Methods("OPTIONS", "GET")
	router.HandleFunc("/courses", e.CORSMiddleware(e.TokenAuthMiddleware(CreateCourse))).Methods("OPTIONS", "POST")
	router.HandleFunc("/courses/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(DeleteCourse))).Methods("OPTIONS", "DELETE")
	router.HandleFunc("/courses/{id}/status", e.CORSMiddleware(e.TokenAuthMiddleware(UpdateCourseStatus))).Methods("OPTIONS", "PUT", "PATCH")
	router.HandleFunc("/courses/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(GetCourse))).Methods("OPTIONS", "GET")
	router.HandleFunc("/courses/{id}", e.CORSMiddleware(e.TokenAuthMiddleware(UpdateCourse))).Methods("OPTIONS", "PUT", "PATCH")
	router.HandleFunc("/courses/{id}/open", e.CORSMiddleware(e.TokenAuthMiddleware(OpenCourse))).Methods("OPTIONS", "GET")

	// Surveys
	router.HandleFunc("/survey", e.CORSMiddleware(e.TokenAuthMiddleware(CreateSurvey))).Methods("OPTIONS", "POST")
	router.HandleFunc("/survey", e.CORSMiddleware(e.TokenAuthMiddleware(GetSurvey))).Methods("OPTIONS", "GET")
